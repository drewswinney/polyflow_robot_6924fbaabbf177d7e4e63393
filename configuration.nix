...
let
  user      = "admin";
  password  = "password";
  hostname  = "6924fbaabbf177d7e4e63393";
  homeDir   = "/home/${user}";
  ...
  services.loki = {
    ...
    configuration = {
      ...
      common = {
        ...
        # IMPORTANT: only stable interface. Removing wlan0/eth0 avoids AP<->STA flaps.
      ...
      # Pi-friendly timeout; reduces "unable to get stream rates from ingester"
      ingester_client = {
        remote_timeout = "10s";
      };
